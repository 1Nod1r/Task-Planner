...
class PresentationView: BaseView {
    ...
    lazy var title = Label(title: "Task Manager", txtColor: .AppColors.x00394C, txtFont: .Almarai.almaraiTitle, txtLines: 0, txtAlignment: .center)
    lazy var subtitle = Label(txtColor: .AppColors.x585A66, txtFont: .Almarai.almaraiSubtitle, txtLines: 0, txtAlignment: .center)
    ...
    func setup() {
        ...
        pageControl.drawer = ExtendedDotDrawer(
            ...
            width: 7,
            space: 10.0,
            indicatorColor: .AppColors.x2FD1C5,
            dotsColor: .AppColors.x2FD1C5,
            isBordered: false,
            borderWidth: 0.0,
