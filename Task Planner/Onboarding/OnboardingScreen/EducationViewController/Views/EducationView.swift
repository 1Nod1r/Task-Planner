...
class EducationView: BaseView {
    ...
    lazy var title = Label(title: "Education level", txtColor: .AppColors.x00394C, txtFont: .Almarai.almaraiTitle, txtLines: 1, txtAlignment: .left)
    lazy var subtitle = Label(txtColor: .AppColors.x585A66, txtFont: .Almarai.almaraiSubtitle, txtLines: 0, txtAlignment: .left)
    ...
    lazy var skipButton = UIButton.highLightedButton(title: "Skip", textColor: .AppColors.x2FD1C5, size: 18)
